    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Нет', 'Нет'), ('Завтрак', 'Завтрак'), ('Обед', 'Обед'), ('Ужин', 'Ужин'), ('Десерт', 'Десерт')], default='Нет', max_length=25, verbose_name='Категория (Время дня)')),
                ('calories', models.PositiveIntegerField(verbose_name='Общая калорийность')),
                ('menus', models.ManyToManyField(related_name='recipies', to='myapp.menu', verbose_name='Типы меню')),
            ],
        ),
        migrations.CreateModel(
            name='Ingredient',
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredients', to='myapp.recipe', verbose_name='Рецепт')),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ...
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='myapp.menu', verbose_name='Тип меню')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='myapp.subscription', verbose_name='Подписка')),
            ],
            options={
                'verbose_name': 'user',
